...
LowShelf::LowShelf(int numChannels)
{
...
void LowShelf::setParameter(int paramID, float value)
{
    switch (paramID)
    {
        case PARAM_1:
...
void LowShelf::prepareToPlay(float sampleRate)
{
...
void LowShelf::process(float **audioBuffer, int numFrames)
{
    for (int channel = 0; channel < m_iNumChannels; channel++)
    {
